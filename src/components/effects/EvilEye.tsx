...
export default function EvilEye({
  ...
  useEffect(() => {
    ...
    // Il container è uno sfondo a schermo intero con z-index negativo: il
    // resto della pagina gli sta sempre sopra, quindi un listener attaccato
    // al container stesso non riceverebbe quasi mai l'evento reale. Si
    // ascolta invece su window (che vede ogni movimento del mouse a
    // prescindere da cosa c'è in primo piano) e si normalizza comunque
    // rispetto al rect del container.
